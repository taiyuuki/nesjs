...
export class Mapper {
     ...
     * @param type 镜像类型
     */
    protected setVRAMMirror(type: number): void {
        ...
        switch (type) {
            ...
            case 2: // VRAM_MIRROR4
                ...
                break
            case 3: // VRAM_MIRROR4L
                this.setmirroring(MirrorType.SS_MIRROR0)
                break
            case 4: // VRAM_MIRROR4H
     ...
     * @param length 长度
     */
    protected SetVROM_Bank(page: number, data: number[], offset: number = 0, length?: number): void {
        this.setVROMBank(page, data, offset, length)
    }
     ...
     * @param bank 银行号
     */
    protected SetVROM_1K_Bank(page: number, bank: number): void {
        this.setVROM1KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetVROM_2K_Bank(page: number, bank: number): void {
        this.setVROM2KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetVROM_4K_Bank(page: number, bank: number): void {
        this.setVROM4KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetVROM_8K_Bank(bank: number): void {
        this.setVROM8KBank(bank)
    }

    /**
     * 设置VROM 8K银行（8个独立银行） (C# 兼容性别名)
     * @param bank0-bank7 各个银行号
     */
    protected SetVROM_8K_Bank8(
        bank0: number, bank1: number, bank2: number, bank3: number,
        bank4: number, bank5: number, bank6: number, bank7: number,
    ): void {
        this.setVROM8KBank8(bank0, bank1, bank2, bank3, bank4, bank5, bank6, bank7)
    }
     ...
     * @param bank 银行号
     */
    protected SetCRAM_1K_Bank(page: number, bank: number): void {
        this.setCRAM1KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetCRAM_2K_Bank(page: number, bank: number): void {
        this.setCRAM2KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetCRAM_4K_Bank(page: number, bank: number): void {
        this.setCRAM4KBank(page, bank)
    }
     ...
     * @param bank 银行号
     */
    protected SetCRAM_8K_Bank(bank: number): void {
        this.setCRAM8KBank(bank)
    }
}
